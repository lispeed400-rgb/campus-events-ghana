...
ZIP_FILE = os.path.join(BASE_DIR, 'deploy_campusevents_bundle.zip')

print(f"[1] Building deployment archive for site {SITE_ID} (campuseventghana.site)...")
...
print(f"\n[2] Uploading ZIP ({os.path.getsize(ZIP_FILE)} bytes) to Netlify Production...")
